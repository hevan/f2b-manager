...
import {TransitOrderItemService} from "../../../shared/services/finance/transitOrderItem.service";



@Component({
    selector: 'app-analysis-trans-order-item',
    templateUrl: './transitem.component.html'
})
export class SaleTransOrderItemComponent implements OnInit {
    ...
    //构造
    constructor(private fb: FormBuilder,private location: Location, private route: ActivatedRoute,private router: Router,private transitOrderItemService:TransitOrderItemService,private authService:AuthService) {
    ...
    paginateQuery(event) {
        ...
        this.transitOrderItemService.pageQuery(params).subscribe(res=>{
            if(res.code == 0){
