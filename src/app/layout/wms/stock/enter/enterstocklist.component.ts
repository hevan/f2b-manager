...
@Component({
    selector: 'app-stock-enterstocklist',
    templateUrl: './enterstocklist.component.html',
    animations: [routerTransition()]
})
export class EnterStockListComponent implements OnInit {
    ...
    paginateQuery(event) {
        ...
        const params = new HttpParams().set('billCode', this.searchData.billCode).set('billType',this.searchData.billType).set('name',this.searchData.name).set('name',this.searchData.name).set('supplyCorpName',this.searchData.supplyCorpName).set('status',this.searchData.status)
