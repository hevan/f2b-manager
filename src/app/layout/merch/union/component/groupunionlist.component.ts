...
@Component({
    selector: 'app-merch-group-union-list',
    templateUrl: './groupunionlist.component.html',
    animations: [routerTransition()]
})
export class GroupUnionListComponent implements OnInit {
    ...
    loadData() {
        ...
        this.groupUnionService.findAllByCorpId(paramsContract).subscribe(res=>{
            if(res.code == 0){
    ...
    toEdit(id){
        this.router.navigate(['/merch/union/groupunionedit', { 'id': id}]);
    }
