...
@Component({
    selector: 'app-merch-union-groupunionview',
    templateUrl: './groupunionview.component.html',
    animations: [routerTransition()]
})
export class GroupUnionViewComponent implements OnInit {
    ...
    //编辑
    toEdit(){
        this.router.navigate(['/merch/union/groupunioneidt', { 'id': this.curId}]);
    }
