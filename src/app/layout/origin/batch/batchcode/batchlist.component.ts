...
export class BatchListComponent implements OnInit {
    ...
    //构造
    constructor(private fb: FormBuilder,private location: Location, private route: ActivatedRoute,private router: Router,private batchCodeService:BatchCodeService,private authService:AuthService) {
    ...
    toView(id){
        this.router.navigate(['/origin/batch/batchview', { 'id': id}]);
    }

    toEdit(id){
        this.router.navigate(['/origin/batch/batchedit', { 'id': id}]);
    }

    //编辑
    toGen(id){
        this.router.navigate(['/origin/batch/origincodegen',{batchCodeId:id}]);
    }
