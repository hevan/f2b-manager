...
@Component({
    selector: 'app-puch-salefarmlist',
    templateUrl: './salefarmlist.component.html',
    animations: [routerTransition()]
})
export class SaleFarmPurchaseListComponent implements OnInit {
    ...
    toView(id){
        this.router.navigate(['/sale/salefarm/salefarmview', { 'id': id}]);
    }

    toEdit(id){
        this.router.navigate(['/sale/salefarm/salefarmedit', { 'id': id}]);
    }
