...
@Component({
    selector: 'app-puch-purchaseedit',
...
export class PurchaseEditComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        let params = new HttpParams().set('code', 'pt_purch_type');
    ...
    selectCorp(){
        ...
        modalRef.result.then((result) => {
           let retData = JSON.parse(result);
            ...
            this.dataForm.patchValue({'supplyLinkMan': retData.supplyLinkMan});
            this.dataForm.patchValue({'supplyLinkTel': retData.supplyLinkTel});
        }, (reason) => {
        });
    }
