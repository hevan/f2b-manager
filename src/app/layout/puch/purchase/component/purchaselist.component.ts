...
@Component({
    selector: 'app-puch-purchaselist',
...
export class PurchaseListComponent implements OnInit {
    ...
    paginateQuery(event) {
        ...
        const params = new HttpParams().set('billCode', this.searchData.billCode).set('billType',this.searchData.billType).set('purchCorpId',this.corp.id).set('name',this.searchData.name).set('supplyCorpName',this.searchData.supplyCorpName).set('status',this.searchData.status)
