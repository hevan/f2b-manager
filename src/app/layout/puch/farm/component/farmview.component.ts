...
@Component({
    selector: 'app-puch-farmview',
    templateUrl: './farmview.component.html',
    animations: [routerTransition()]
})
export class FarmPurchaseViewComponent implements OnInit {
    ...
    loadPurchItem(){
        ...
        this.farmPurchaseItemService.findAll(paramsMedia).subscribe(res=>{
            if(res.code == 0){
    ...
    //编辑
    toEdit(){
        this.router.navigate(['/puch/farm/farmedit',{id:this.curId}]);
    }
