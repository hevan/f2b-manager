...
export class OriginCodeService {
  ...
  public genCode(params:any):Observable<any> {
    return this.http.post(Keys.SERVER_URL + '/origin/v2/secure/originCode/gen',null, {params:params,headers: this._authService.getPostHeaders(Keys.HTTP_FORM,true)})
        .pipe(
